...
function Strategy(options, verify) {
  ...
  this._usernameHeader = options.usernameHeader ? options.usernameHeader : 'x-username';
  this._tokenHeader    = options.tokenHeader ? options.tokenHeader : 'x-token';
  
  this._usernameField = options.usernameField ? options.usernameField : 'username';
  this._tokenField    = options.tokenField ? options.tokenField : 'token';

  this._usernameQuery = options.usernameQuery ? options.usernameQuery : this._usernameField;
